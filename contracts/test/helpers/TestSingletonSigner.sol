...
/**
 * @title TestSingletonSigner - A custom singleton signer with XOR-based signing scheme.
 * @dev Mirrors the reference safe-modules TestSingletonSigner.sol contract.
 *      Uses a very silly signing scheme where the `message = signature ^ key`.
 */
...
/**
 * @title TestSingletonSignerFactory - Factory for deploying TestSingletonSigner instances via CREATE2.
 */
